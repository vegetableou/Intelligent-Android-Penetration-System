...
.method public constructor <init>(Landroid/content/Context;Lk1/g;)V
    ...
    const-string v6, "Kotlin extensions for \'core\' artifact."

    const-wide/16 v2, 0x0

    const-string v4, "Core Kotlin Extensions"
    ...
    const-string v14, "The Android Open Source Project"
    ...
    const-string v22, "The Android Open Source Project"

    const-string v23, "Modular and customizable Material Design UI components for Android."

    const-wide/16 v19, 0x2

    const-string v21, "Material Components for Android"

    const-string v24, "Apache-2.0"
    ...
    const-string v15, "Display Views or Fragments in a swipeable format."

    const-wide/16 v11, 0x5

    const-string v13, "ViewPager2"
    ...
    const-string v13, "Scalable Size Unit"

    const-string v16, "MIT license"

    const-string v17, "https://github.com/intuit/sdp"
    ...
    const-string v22, "Lopez Mikhael"

    const-string v23, "Create circular view in android (change color, border & shadow)."

    const-wide/16 v19, 0x8

    const-string v21, "CircleView"

    const-string v24, "Apache-2.0"

    const-string v25, "https://github.com/lopspower/CircleView"
    ...
    const-string v15, "Mihai Preda"

    const-string v16, "Java Arithmetic Engine (formerly Arity)."

    const-wide/16 v12, 0x9

    const-string v14, "Arithmetic"

    const-string v17, "Apache-2.0"

    const-string v18, "https://github.com/preda/arithmetic"
    ...
    const-string v24, "You Apps"

    const-string v25, "Unit converters."

    const-wide/16 v21, 0xa

    const-string v23, "Converter by CalcYou"

    const-string v26, "GPL-3.0"

    const-string v27, "https://github.com/you-apps/CalcYou"
