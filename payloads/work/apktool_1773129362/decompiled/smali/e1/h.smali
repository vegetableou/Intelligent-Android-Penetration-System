...
.method public constructor <init>(Ljava/lang/CharSequence;Landroid/text/TextPaint;I)V
    ...
    iput p1, p0, Le1/h;->d:I

    sget-object p1, Landroid/text/Layout$Alignment;->ALIGN_NORMAL:Landroid/text/Layout$Alignment;

    iput-object p1, p0, Le1/h;->e:Landroid/text/Layout$Alignment;
    ...
    iput-boolean p1, p0, Le1/h;->j:Z

    const/4 p1, 0x0

    iput-object p1, p0, Le1/h;->l:Landroid/text/TextUtils$TruncateAt;
...
.method public final a()Landroid/text/StaticLayout;
    ...
    iget-object v0, p0, Le1/h;->a:Ljava/lang/CharSequence;

    if-nez v0, :cond_0

    const-string v0, ""

    iput-object v0, p0, Le1/h;->a:Ljava/lang/CharSequence;
    ...
    iget-object v6, p0, Le1/h;->l:Landroid/text/TextUtils$TruncateAt;
    ...
    iget v6, p0, Le1/h;->d:I

    invoke-static {v3, v6}, Ljava/lang/Math;->min(II)I

    move-result v3

    iput v3, p0, Le1/h;->d:I

    iget-boolean v6, p0, Le1/h;->k:Z

    if-eqz v6, :cond_2

    iget v6, p0, Le1/h;->f:I

    if-ne v6, v5, :cond_2

    sget-object v6, Landroid/text/Layout$Alignment;->ALIGN_OPPOSITE:Landroid/text/Layout$Alignment;

    iput-object v6, p0, Le1/h;->e:Landroid/text/Layout$Alignment;
    ...
    iget-object v1, p0, Le1/h;->e:Landroid/text/Layout$Alignment;
    ...
    iget-object v1, p0, Le1/h;->l:Landroid/text/TextUtils$TruncateAt;
