...
.method public constructor <init>(Lcom/google/android/material/textfield/MaterialAutoCompleteTextView;Landroid/content/Context;I[Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lp1/s;->c:Lcom/google/android/material/textfield/MaterialAutoCompleteTextView;
...
.method public final a()V
    ...
    iget-object v0, p0, Lp1/s;->c:Lcom/google/android/material/textfield/MaterialAutoCompleteTextView;
    ...
    :goto_1
    iput-object v5, p0, Lp1/s;->b:Landroid/content/res/ColorStateList;
    ...
    iget-object v4, v0, Lcom/google/android/material/textfield/MaterialAutoCompleteTextView;->l:Landroid/content/res/ColorStateList;

    invoke-virtual {v4, v3, v2}, Landroid/content/res/ColorStateList;->getColorForState([II)I

    move-result v4

    iget-object v5, v0, Lcom/google/android/material/textfield/MaterialAutoCompleteTextView;->l:Landroid/content/res/ColorStateList;

    invoke-virtual {v5, v1, v2}, Landroid/content/res/ColorStateList;->getColorForState([II)I

    move-result v5

    iget v6, v0, Lcom/google/android/material/textfield/MaterialAutoCompleteTextView;->k:I

    invoke-static {v4, v6}, LF/a;->c(II)I
    ...
    :cond_2
    iput-object v4, p0, Lp1/s;->a:Landroid/content/res/ColorStateList;
...
.method public final getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    iget-object p3, p0, Lp1/s;->c:Lcom/google/android/material/textfield/MaterialAutoCompleteTextView;
    ...
    iget-object p3, p0, Lp1/s;->b:Landroid/content/res/ColorStateList;

    if-eqz p3, :cond_0

    iget-object p3, p0, Lp1/s;->a:Landroid/content/res/ColorStateList;

    invoke-static {v0, p3}, LG/a;->h(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V

    new-instance p3, Landroid/graphics/drawable/RippleDrawable;

    iget-object v2, p0, Lp1/s;->b:Landroid/content/res/ColorStateList;
