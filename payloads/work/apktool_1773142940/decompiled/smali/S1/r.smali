...
.method static constructor <clinit>()V
    ...
    const-string v16, "tgd(x)=tand(x)"

    const-string v17, "rnd(max)=rnd()*max"

    const-string v0, "log(x)=ln(x)*0.43429448190325182765"

    const-string v1, "log10(x)=log(x)"

    const-string v2, "lg(x)=log(x)"

    const-string v3, "log2(x)=ln(x)*1.4426950408889634074"

    const-string v4, "lb(x)=log2(x)"

    const-string v5, "log(base,x)=ln(x)/ln(base)"

    const-string v6, "gamma(x)=(x-1)!"

    const-string v7, "deg=0.017453292519943295"

    const-string v8, "indeg=57.29577951308232"

    const-string v9, "sind(x)=sin(x deg)"

    const-string v10, "cosd(x)=cos(x deg)"

    const-string v11, "tand(x)=tan(x deg)"

    const-string v12, "asind(x)=asin(x) indeg"

    const-string v13, "acosd(x)=acos(x) indeg"

    const-string v14, "atand(x)=atan(x) indeg"

    const-string v15, "tg(x)=tan(x)"

    const-string v18, "re(x)=real(x)"

    const-string v19, "im(x)=imag(x)"
